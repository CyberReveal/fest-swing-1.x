...
public class AWT {
     ...
     * @since 1.2
     */
    public static boolean isPointInScreenBoundaries(@Nonnull final JComponent c, @Nonnull final Point p) {
     ...
     * @since 1.2
     */
    public static boolean isPointInScreenBoundaries(@Nonnull final Point p) {
        Rectangle screen = new Rectangle(TOOLKIT_PROVIDER.defaultToolkit().getScreenSize());
     ...
     */
    @RunsInCurrentThread
    public static @Nullable Point translate(@Nonnull final Component c, final int x, final int y) {
     ...
     */
    @RunsInCurrentThread
    public static @Nonnull Point centerOf(@Nonnull final Component c) {
     ...
     */
    @RunsInCurrentThread
    public static @Nonnull Point centerOfVisibleRect(@Nonnull final JComponent c) {
     ...
     */
    @RunsInCurrentThread
    public static @Nonnull Point centerOf(@Nonnull final Rectangle r) {
     ...
     */
    @RunsInCurrentThread
    public static @Nonnull Insets insetsFrom(@Nonnull final Container c) {
        try {
     ...
     */
    public static boolean isAppletViewer(@Nullable final Component c) {
     ...
     */
    public static boolean isSharedInvisibleFrame(@Nullable final Component c) {
        if (c == null) {
            return false;
        }
     ...
     */
    @RunsInCurrentThread
    public static boolean isHeavyWeightPopup(@Nonnull final Component c) {
    ...
    @RunsInCurrentThread
    private static @Nullable String obtainNameSafely(@Nonnull final Component c) {
    ...
    /**
     * <p>
     * Returns the invoker, if any, of the given AWT or Swing {@code Component}; or {@code null}, if the
     ...
     *
     * @param c the given {@code Component}.
     * @return the invoker, if any, of the given {@code Component}; or {@code null}, if the {@code Component} is not on
     *         a
     *         pop-up of any sort.
     */
    @RunsInCurrentThread
     ...
     */
    @RunsInCurrentThread
    public static @Nullable Point locationOnScreenOf(@Nonnull final Component c) {
    ...
    public static boolean isAWTTreeLockHeld() {
        ...
        // From Abbot: Hack based on 1.4.2 java.awt.PopupMenu implementation, which blocks the event dispatch thread
        // while
    ...
    // BSmith 12/01/2015 Updated to a 3 minute timeout as required by cyberreveal. Could also refactor this whole class
    // as per assertj
    private static class ThreadStateChecker extends Thread {
        private final Object lock;

        public ThreadStateChecker(@Nonnull final Object lock) {
